...
TWISTUI_VERSION := 1.0
TWISTUI_CODENAME := Helix

# Custom Versioning
CUSTOM_VERSION := TwistUI-v$(TWISTUI_VERSION)-$(TWISTUI_BASE_VERSION)-$(TWISTUI_CODENAME)-$(CUSTOM_PLATFORM_VERSION)-$(CUSTOM_BUILD)-$(CUSTOM_BUILD_DATE)-$(CUSTOM_BUILD_TYPE)
